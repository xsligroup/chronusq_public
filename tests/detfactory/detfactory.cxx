...
void DetFactory_TEST() {
  ...
  std::cout << "**** Test GASCI Infrastructure ****" << std::endl;
  ...
  std::cout << "unit8ToString :  " << +a1[15] << " to " << determinantToString(a1[15], 5) << std::endl;
  std::cout << "unit16ToString : " << a2[15]  << " to " << determinantToString(a2[15], 15) << std::endl;
  std::cout << "unit32ToString : " << a3[15]  << " to " << determinantToString(a3[15], 25) << std::endl;
  std::cout << "unit64ToString : " << a4[15]  << " to " << determinantToString(a4[15], 35) << std::endl;
  ...
  std::cout << "unit8ToString :  (" << +a1[15] << "," << +a1[5] << ") to " 
            << determinantToString(d1, nO1) << std::endl;
  std::cout << "unit16ToString : (" << a2[15]  << "," <<  a2[5] << ") to " 
            << determinantToString(d2, nO2) << std::endl;
  std::cout << "unit32ToString : (" << a3[15]  << "," <<  a3[5] << ") to " 
  ...
  std::cout << "stringToUnit8_t  : " << s1 << " to " << +stringToDeterminant<uint8_t >(s1) << std::endl;
  std::cout << "stringToUnit16_t : " << s1 << " to " << stringToDeterminant<uint16_t>(s1) << std::endl;
  std::cout << "stringToUnit32_t : " << s1 << " to " << stringToDeterminant<uint32_t>(s1) << std::endl;
  std::cout << "stringToUnit64_t : " << s1 << " to " << stringToDeterminant<uint64_t>(s1) << std::endl;
  ...
  std::cout << "stringToUnit8_t  : " << s2 << " to (" <<+d1[0] << "," <<+d1[1] << ")" << std::endl;
  std::cout << "stringToUnit16_t : " << s2 << " to (" << d2[0] << "," << d2[1] << ")" << std::endl;
  std::cout << "stringToUnit32_t : " << s2 << " to (" << d3[0] << "," << d3[1] << ")" << std::endl;
  std::cout << "stringToUnit64_t : " << s2 << " to (" << d4[0] << "," << d4[1] << ")" << std::endl;
