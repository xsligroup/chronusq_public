...
void ConventionalSCFNew<singleSlaterT,MatsT,IntsT>::modifyFock(EMPerturbation& pert) {
 ...
 */
template <template <typename, typename> class singleSlaterT, typename MatsT, typename IntsT>
  void ConventionalSCFNew<singleSlaterT,MatsT,IntsT>::fockDamping() {
 ...
 */
template <template <typename, typename> class singleSlaterT, typename MatsT, typename IntsT>
  void ConventionalSCFNew<singleSlaterT,MatsT,IntsT>::scfCDIIS(size_t nExtrap, size_t iDIIS) {
 ...
 */
template <template <typename, typename> class singleSlaterT, typename MatsT, typename IntsT>
  void ConventionalSCFNew<singleSlaterT,MatsT,IntsT>::scfEDIIS(size_t nExtrap, size_t iDIIS, EMPerturbation& pert) {
  ...
  diisEnergy[iDIIS] = this->singleSlaterSystem.getTotalEnergy();
...
template <template <typename, typename> class singleSlaterT, typename MatsT, typename IntsT>
  void ConventionalSCFNew<singleSlaterT,MatsT,IntsT>::scfCEDIIS(size_t nExtrap, size_t iDIIS, EMPerturbation& pert) {
 ...
 */
template <template <typename, typename> class singleSlaterT, typename MatsT, typename IntsT>
  void ConventionalSCFNew<singleSlaterT,MatsT,IntsT>::ediisErrorMetric(size_t iDIIS, size_t nExtrap) {
 ...
 */
template <template <typename, typename> class singleSlaterT, typename MatsT, typename IntsT>
  void ConventionalSCFNew<singleSlaterT,MatsT,IntsT>::diisCombineMat(std::vector<MatsT> c, size_t nExtrap) {
  ...
  this->ao2orthoFock(fock);
  this->ao2orthoDen(den);
 ...
 */
template <template <typename, typename> class singleSlaterT, typename MatsT, typename IntsT>
  void ConventionalSCFNew<singleSlaterT,MatsT,IntsT>::allocExtrapStorage() {
...
template <template <typename, typename> class singleSlaterT, typename MatsT, typename IntsT>
  ...
  for(size_t a = 0; a < this->fockSquareOrtho.size(); a++ ) {
    ...
    // Compute F*D
    blas::gemm(blas::Layout::ColMajor, blas::Op::NoTrans, blas::Op::NoTrans, NB, NB, NB, MatsT(1.), this->fockSquareOrtho[a].pointer(), NB, this->onePDMSquareOrtho[a].pointer(), NB, MatsT(0.), SCR.pointer(), NB);
    // Compute FD - DF
...
template <template <typename, typename> class singleSlaterT, typename MatsT, typename IntsT>
  double ConventionalSCFNew<singleSlaterT,MatsT,IntsT>::computeFDCConv() {
