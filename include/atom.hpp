  ...
  static std::map<std::string,Atom> atomicReference(
    {
      ...
      { "RF-267"   , { 104  , 104.  , 267  , 267.12179       ,   2.01   } },
      { "DB-262"   , { 105  , 105.  , 262  , 262.11415       ,   2.01   } },
      { "DB-268"   , { 105  , 105.  , 268  , 268.12567       ,   2.01   } },
      { "SG-266"   , { 106  , 106.  , 266  , 266.12193       ,   2.01   } },
      { "SG-271"   , { 106  , 106.  , 271  , 271.13393       ,   2.01   } },
      { "BH-264"   , { 107  , 107.  , 264  , 264.12473       ,   2.01   } },
      { "BH-272"   , { 107  , 107.  , 272  , 272.13826       ,   2.01   } },
      { "HS-270"   , { 108  , 108.  , 270  , 270.13429       ,   2.01   } },
      { "MT-268"   , { 109  , 109.  , 268  , 268.13882       ,   2.01   } },
      { "MT-276"   , { 109  , 109.  , 276  , 276.15159       ,   2.01   } },
      { "DS-281"   , { 110  , 110.  , 281  , 281.16451       ,   2.01   } },
      { "RG-280"   , { 111  , 111.  , 280  , 280.16514       ,   2.01   } },
      { "CN-285"   , { 112  , 112.  , 285  , 285.17712       ,   2.01   } },
      { "NH-284"   , { 113  , 113.  , 284  , 284.17873       ,   2.01   } },
      { "FL-289"   , { 114  , 114.  , 289  , 289.19042       ,   2.01   } },
      { "MC-288"   , { 115  , 115.  , 288  , 288.19274       ,   2.01   } },
      { "LV-293"   , { 116  , 116.  , 293  , 293.20449       ,   2.01   } },
      { "TS-292"   , { 117  , 117.  , 292  , 292.20746       ,   2.01   } },
      { "OG-294"   , { 118  , 118.  , 294  , 294.21392       ,   2.01   } }
    }
