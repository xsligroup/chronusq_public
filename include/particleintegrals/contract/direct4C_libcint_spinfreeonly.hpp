...
namespace ChronusQ {
  ...
  void GTODirectRelERIContraction<MatsT,IntsT>::directScaffoldLibcintSpinFreeOnly(
...
//          double shMax = std::max(ShBlkNorms[0][s1 + s2*nShell],ShBlkNorms[0][s3 + s4*nShell]);
  ...
  template <>
  void GTODirectRelERIContraction<double,double>::directScaffoldLibcintSpinFreeOnly(
    MPI_Comm comm, const bool screen,
  ...
  template <>
  void GTODirectRelERIContraction<dcomplex,dcomplex>::directScaffoldLibcintSpinFreeOnly(
    MPI_Comm comm, const bool screen,
