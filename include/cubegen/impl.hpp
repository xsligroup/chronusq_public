...
namespace ChronusQ {
    ...
    */
    ...
    void CubeGen::evalCube(std::string fileNamePrefix,std::shared_ptr<cqmatrix::PauliSpinorMatrices<LocMatsT>> oPDM) {
      ...
      if( getDenEval() ){
        ...
        if( oPDM->hasXY() ){
          ...
          evalDenCube(oPDM->Y().pointer());

        }

      }else{
        CErr("CubeGen for non-Density Cubes NYI!");
      }
