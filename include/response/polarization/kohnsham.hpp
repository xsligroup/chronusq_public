...
namespace ChronusQ {
  ...
  template <typename U>
  void PolarizationPropagator<KohnSham<MatsT, IntsT>>::formLinearTrans_direct_impl(
    ...
    std::shared_ptr<TPIContractions<U,IntsT>> TPI =
        TPIContractions<MatsT,IntsT>::template convert<U>(ks.TPI);
  ...
  template <>
  void PolarizationPropagator<KohnSham<double,double>>::formLinearTrans_direct(
  ...
  template <>
  void PolarizationPropagator<KohnSham<dcomplex,double>>::formLinearTrans_direct(
    MPI_Comm c, RC_coll<double> x, SINGLESLATER_POLAR_COPT op, 
    bool noTrans){ 
  ...
  template <>
  void PolarizationPropagator<KohnSham<dcomplex,dcomplex>>::formLinearTrans_direct(
    MPI_Comm c, RC_coll<double> x, SINGLESLATER_POLAR_COPT op, 
    bool noTrans){ 
