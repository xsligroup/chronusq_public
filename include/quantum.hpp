...
namespace ChronusQ {
  ...
  public:
    ...
    std::shared_ptr<cqmatrix::Matrix<MatsT>> oneRDM = nullptr; ///< 1RDM array (Scalar + Magnetization)
    std::shared_ptr<cqmatrix::Matrix<MatsT>> oneRDMB = nullptr; ///< 1RDM array (Scalar + Magnetization)
