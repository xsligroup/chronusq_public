...
void NewOrbitalRotation<MatsT, IntsT>::rotateMO(EMPerturbation & pert, 
...
// Other headers
#include <neworbitalrotation/fock.hpp>      // fock matrix implementation 
#include <neworbitalrotation/gradient.hpp>  // gradient implementation
#include <neworbitalrotation/hessian.hpp>   // hessian implementation
#include <neworbitalrotation/ivo.hpp>   // hessian implementation
